// Generated on 2015-07-10 using generator-backbone
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            jst: {
                files: [
                    '<%= yeoman.app %>/javascripts/templates/*.ejs'
                ],
                tasks: ['jst']
            },
            test: {
                files: ['<%= yeoman.app %>/javascripts/{,*/}*.js', 'test/spec/**/*.js'],
                tasks: ['test:true']
            }
        },
        connect: {
        ...
        jst: {
            compile: {
                files: {
                    '.tmp/javascripts/templates.js': ['<%= yeoman.app %>/javascripts/templates/*.ejs']
                }
            }
        },
        rev: {
